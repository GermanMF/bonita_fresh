...
<body class="cSection2">
  ...
  <div id="language" class="right-align">
   <a href="../" class="waves-effect waves-light btn">Español</a>
 </div>
          ...
          <li  class="opMenos menuShow">
            ...
            <div class="collapsible-body  green-text text-lighten-5 ccolor tjustify">
              <div class="owl-carousel carrusel1">
                <div>
                  <h5 class="calign cTitle pCh ">Mission</h5>
                  <p class="tjustify">
                    Offer a product with standards of international quality to meet the demand for a inflexible consumer, improving the generation of greater value to the product.
                  </p>
                </div>
                <div>
                  <h5 class="calign cTitle ">Vission</h5>
                  <p class="tjustify">
                    Consolidate us as the leader in sales in the region as the best choice for consumers, and be a highly competitive company in the export of blackberries with recognized quality.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="owl-carousel carrusel1">
                <div>
                  <p class="pBoth calign">
                    Maintain constant administrative and operational efficiency at the level of the customers in the United States of America and rest of the world.
                  </p>
                </div>
                <div>
                  <p class="pBoth calign">
                    Strengthen the relationship with customers to provide them with a better product.
                  </p>
                </div>
                <div>
                  <p class="pBoth calign">
                    Stay on the cutting edge using the latest technology to facilitate operations and gain the advantage of timely information.
                  </p>
                </div>
                <div>
                  <p class="pBoth calign">
                    Have staff committed with the objectives to provide solutions to the everyday events.
                  </p>
                </div>
                <div>
                  <p class="pBoth calign">
                    Keep the brand recognition that clearly identifies the product in the international market.
                  </p>
                </div>
                <div>
                  <p class="pBoth calign">
                    Maintain up-to- date national and international certificates of quality.
                  </p>
                </div>
              </div>
            </div>
  ...
  <div class="row container grey lighten-2">
    ...
    <div class="col s12 tjustify  grey-text text-darken-4 bText z2">
      <p class="col l12 pChMed pText">
        We cumply with standards required by agencies such as: the Local Board of Health Vegetable, Secretariat of Agriculture, Livestock, Rural Development, Fishing and Food, the U.S. Department of Agriculture (USDA), the Food and Drug Adminstration (FDA), reports of quality approved by Produce Inspectors of America (PIA), the Environmental Protection Agency (EPA), and the NSF Davis Fresh.
      </p>
    </div>
...
<section class="cSection psides mTopNeg" id="historia"> <a name="historia"></a>
  <div class="row container">
    ...
    <div class="col s12 pMed" >
      <p class="col l12 pChMed green-text text-lighten-5 tjustify">
        The company was created in may of the year 2010 as a society of rural production of limited liability. It comes as response to a need of producers of various localities of the municipality of Ario de Rosales, for the purpose of creating a skilled marketer to establish commercial relationships for better income for its product.
      </p>
      <p class="col l12 pChMed green-text text-lighten-5 tjustify">
        According to the legal statutes, the administration of the society is carried out by the governing body, composed of a President, a Treasurer and a Secretary.
      </p>
      <p class="col l12 pChMed green-text text-lighten-5 tjustify">
        The Supervisory Board is appointed by the Assembly to oversee the company statutory and administrative and is composed of a President, a Secretary and a Vowel.
      </p>
    </div>
  </div>
</section>
...
<div id="modal1" class="modal">
  <div class="modal-content white black-text">
    <h4>Legal notice</h4>
    <p>All content of the web site such as title or brand name, texts, photographs, graphics, images, icons, technology, software, links and other audiovisual or sound contents, as well as its graphic design are the intellectual property of Bonita Fresh, without transfer of rights of exploitation to the user beyond what is strictly necessary for the correct use of the site.
    </p>
    <p>
     The end-user agrees to use the content in accordance with the law and this Legal notice, as well as to the other applicable provisions. Users of the site are only authorized to view and make reproductions intended for private or commercial use linked to the products offered.
   </p>
 </div>
